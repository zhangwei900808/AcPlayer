    ...
    AcPlayer.prototype = {
        ...
        monitorCurrentTime() {
            ...
            this.ivl = setInterval(function() {
                ...
                console.log(that.currentTime) return that.currentTime;
            },
            100)
        },
        ...
        init: function() {
					alert(1)
            for (var subName in this.cssClassSub) this.cssClass[subName] = this.params.classPrefix + '-' + this.cssClassSub[subName];
            ...
            this.$element.each(function() {
                ...
                thePlayer.find('.' + that.cssClass.playPause).on('click',
                function() {
